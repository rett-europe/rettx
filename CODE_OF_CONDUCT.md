...
in the rettX community a harassment-free experience for everyone,
...
rettX exists to support people living with Rett Syndrome and their
families. We hold ourselves to a high standard because the people we
serve depend on it.
...
- Focusing on what is best not just for us as individuals, but for the
  overall community — including patients, caregivers, and clinicians.
- Treating clinical and patient-derived information with the
  seriousness it deserves, even when it is anonymised or hypothetical.
...
- Sharing real patient data, identifiable health information, or any
  content that could identify an individual living with Rett Syndrome,
  in any public channel of this project.
...
It also applies to all repositories in the rettX ecosystem (`rettx`,
